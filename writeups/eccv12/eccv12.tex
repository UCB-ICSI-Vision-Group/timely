...
\todo{
Consider revising the above to make a single action compute all the scene classifiers at once.
}
...
\todo{What's the difference here between minimizing entropy and maximizing expected information gain over the length of the episode?}
