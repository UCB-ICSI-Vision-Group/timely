...
\begin{figure}[h!]
\centering
\subfloat[MRF]{\includegraphics[width=0.46\linewidth]{figures/inf_model_mrf.pdf}}
...
Exact inference is of course intractable in this model; we make use of Loopy Belief Propagation, which provides no general convergence guarantees but has been shown to work well empirically \todo{cite}.
