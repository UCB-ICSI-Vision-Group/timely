...
\center{\includegraphics[width=0.56\linewidth]
  ...
  \caption{We aim for \emph{Anytime} performance within the bounds of the curve. That is, the policy should give the best possible answer at any time from start time $T_s$ to deadline $T_d$. \todo{CAN WE PUT PICTURES OF DETECTORS IN HERE?}}
