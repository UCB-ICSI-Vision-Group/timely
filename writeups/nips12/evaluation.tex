...
\begin{figure}[h!]
\centering
\subfloat[AP vs. Time curves for Random, Oracle, the Fixed Order baseline, and our best-performing policy, with start time of 5 seconds and deadline of 15 seconds.]{\includegraphics[width=0.47\linewidth]
