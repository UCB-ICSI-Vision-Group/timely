...
% At time of publication we will maketitle our code available, which is easily extendible to new detectors, classifiers, tasks and reward functions due to the modular nature of our formulation.
\end{abstract}
