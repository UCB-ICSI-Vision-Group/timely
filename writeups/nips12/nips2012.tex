...
In contrast to previous work, our method significantly diverts from the predominant greedy strategies, and is able to learn to take actions with deferred values.
We evaluate our method with a novel \emph{timeliness} measure, computed as the area under an Average Precision (AP) vs. Time curve.
