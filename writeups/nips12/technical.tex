...
Additionally, we include the mean and maximum entropy of class presence and time features that represent the times until start and deadline, for a total of $F = 1+|K|*2+6$ features.
...
\subfloat[RL]{\includegraphics[width=0.49\linewidth]{../figures/weights_rl}}
